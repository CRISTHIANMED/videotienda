...
public class SecurityServiceImpl implements SecurityService {
    ...
    public UserResponse validateUser(String username, String password) {
        ...
        // if (userOp.isEmpty()) {
        // throw new RuntimeException("Ususario no existe");
        // }
    ...
    public void createUser(UserRequest user) {
        ...
        if (userOp.isPresent()) {
            throw new RuntimeException("Ya existe un usuario reistrado con ese correo electrónico");
        }

        var userDb = new User();
        userDb.setUsername(user.getUsername());
        userDb.setPassword(user.getPassword());
        userDb.setUsername(user.getName());
